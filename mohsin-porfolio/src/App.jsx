...
function App() {
  ...
  const sun = (
    ...
    <path 
      ...
      6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25
      12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 
  ...
  return (
    <>
      ...
      <div className='bg-white
        ...
        min-h-screen
        font-inter'>
        <div className='max-w-5x1 x-11/12 mx-auto'>
          <Intro/>
          <Portfolio/>
          <Timeline/>
          <Contact/>
